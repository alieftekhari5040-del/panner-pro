        ...
        {schedule.map((slot) => (
          ...
          >
            ...
            <button
              ...
              className="no-print opacity-0 group-hover:opacity-100 focus:opacity-100 text-purple-400/60 hover:text-red-400 p-1.5 transition-all shrink-0 hover:scale-110"
              title="حذف این ردیف"
            >
