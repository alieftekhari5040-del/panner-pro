    ...
    <div className="neon-box w-full p-5 sm:p-6 flex flex-col gap-4">
      ...
      <div className="neon-inner-box p-4 sm:p-6 flex flex-col gap-3">
        {lessons.map((lesson, idx) => (
          <div key={idx} className="row-interactive flex items-center gap-3 p-2.5 rounded-xl group">
            ...
            <input
              ...
              className="w-full bg-transparent pb-1.5 px-1 text-sm sm:text-base text-purple-100 placeholder-purple-400/40 border-b border-purple-500/30 focus:border-purple-300 outline-none transition-colors"
            />
            <button
